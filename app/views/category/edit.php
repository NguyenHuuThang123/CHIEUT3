...
<div class="container mt-5">
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            <?php endif; ?>
            <form method="POST" action="/webbanhang/Category/update" id="categoryForm" onsubmit="return validateForm();">
                ...
                <div class="mb-3">
                    ...
                    <textarea id="description" name="description" class="form-control" rows="5" placeholder="Nhập mô tả danh mục"><?php echo htmlspecialchars($category->description ?? '', ENT_QUOTES, 'UTF-8'); ?></textarea>
